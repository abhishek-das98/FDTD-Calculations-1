# -*- coding: utf-8 -*-
"""bullseyeQFactorCalculationReal.ipynb
...
sim_data = web.load(task_id, path='data/sim_data_mode.hdf5')
print(sim_data.log)

sim_data = td.SimulationData.from_file(fname = 'data/sim_data_mode.hdf5')
